defmodule SlideAffordanceServer.Deck do
  ...
  defp captions do
    [
      ...
      {147, "Section 3 Walk the walk"},
      {148, "Subheading: Respect their property"},
      {149, "A play about bug tickets"},
      {150, "Adrian's thought bubble"},
      {151, "Ant: Ahem..."},
      {152, "Ant: And why not?"},
      {153, "Ant: Correct, they belong to your tester."},
      {154, "Ant: Remember what Julia said. You explain, she decides."},
      {156, "Ant: If you value your safety"},
      {157, "Ant: Like I said, she decides."},
      {158, "Property of QA: Bug tickets, QA Environments, Test plans"},
